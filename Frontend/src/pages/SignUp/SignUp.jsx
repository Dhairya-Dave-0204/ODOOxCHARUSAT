      ...
      <div className="flex flex-col items-center justify-center w-full p-8 xl:w-1/2">
        <div className="w-full max-w-md">
          ...
          <p className="mt-3 text-xl text-gray-600">
            Forgot password? <span onClick={() => setShowForgotPassword(true)} className="cursor-pointer text-primary">Click here</span>
          </p>
        </div>
      </div>
      {showForgotPassword && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/40">
          <div className="p-6 bg-white rounded-lg w-96">
            ...
            />
            <button onClick={handleForgotPassword} className="w-full p-3 text-white rounded-lg bg-primary hover:bg-secondary">
              Send Mail
            </button>
