...
function DocCategory() {
  ...
  return (
    <>
      ...
      <div onClick={() => navigate("/doc-category")} className="grid grid-cols-1 gap-16 px-12 py-6 mb-28 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6 xl:px-40">
        ...
        <div onClick={() => navigate("/doc-category")} className="flex flex-col items-center justify-center p-8 min-w-[230px] cursor-pointer bg-rgba hover:bg-hoverrgba transition-all duration-500 shadow-md">
          <div className="bg-[#fefffe] h-32 w-32 mb-5 rounded-[50%] flex items-center justify-center">
        ...
        <div onClick={() => navigate("/doc-category")} className="flex flex-col items-center justify-center p-8 min-w-[230px] cursor-pointer bg-rgba hover:bg-hoverrgba transition-all duration-500 shadow-md max-[425px]:hidden">
          <div className="bg-[#fefffe] h-32 w-32 mb-5 rounded-[50%] flex items-center justify-center">
