...
public class MedicalReportPdfGenerator {
    ...
    public static void generateReport(String csvFilePath, String outputDirectory) {
        try {
            ...
            for (int i = 1; i < lines.size(); i++) { // Skip header row
                ...
                String baseFileName = "patient_report_" + i;
                ...
                try (PdfWriter writer = new PdfWriter(pdfFilePath);
                    ...
                    document.add(boldText("Patient Name: "));
                    document.add(boldText("Patient ID: "));
                    ...
                    document.add(new Paragraph(values[0]));
                    document.add(new Paragraph("\n"));
