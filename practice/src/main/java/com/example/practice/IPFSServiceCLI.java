...
public class IPFSServiceCLI {
    ...
    public IPFSServiceCLI() {
        ...
        this.credentials = Credentials.create("0x244b198175195c413f83982e11a4de474c7b98a0b8d673f16dfa001d45e9904c");
    ...
    public String storeCIDInBlockchain(String cid) throws Exception {
        ...
        Transaction transaction = Transaction.createFunctionCallTransaction(
                ...
                "0xDA0bab807633f07f013f94DD0E6A4F96F8742B53", // Contract address
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // Test with a file
        File file = new File("D:\\generated_reports\\patient_report_1"); // Replace with your file path
